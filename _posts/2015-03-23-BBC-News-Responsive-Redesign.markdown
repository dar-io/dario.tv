...
section--body:
  - Theme-Classes: block-mt bg-snow
    ...
    Right-Side-Column:
      - When: "2013 - 2015"
        Product: BBC News
        Platform: |
           <a class="anchor-underline-light" href="http://www.bbc.co.uk/news">bbc.co.uk/news</a>
        Roles:
          - Role: "UX Lead"
          - Role: "Ideation"
          - Role: "Wireframing"
  ...
  - Theme-Classes: block-mt block-mb bg-gray-100 paragraph-decor
    H3-Heading: My Role
  ...
  - Theme-Classes: block-mt block-mb bg-gray-100
    Subheading: DESIGN PROCESS
    Description:
      - H4-Heading: "Stakeholder Workshop"
  ...
  - Theme-Classes: block-mt bg-snow
    ...
    Media:
      - Layout-Classes: align-content-center col-sm-12 col-lg-10 mt-3 mt-lg-5
  ...
  - Theme-Classes: bg-navy-deep text-snow collapse multi-collapse
    id: multiCollapse_1
    H3-Heading: BBC Mundo & BBC Hindi Research
    Description:
      - H4-Heading: Methodology
    ...
    Secondary-Column:
      - Secondary-Column-Classes: mt-lg-7 offset-md-0 col-sm-12 col-md-10 col-lg-4 col-xl-4
        Description:
          - H4-Heading: Research Objectives
  ...
  - Theme-Classes: collapse multi-collapse block-mt bg-stone-deep text-snow
    ...
    H3-Heading: Research Overview
    Description:
      - H4-Heading: Prototype was the favourite choice
  ...
  - Theme-Classes: collapse multi-collapse block-mt bg-navy text-snow
    ...
    Subheading: RESEARCH OVERVIEW
    Description:
      - H4-Heading: Better use of images
  ...
  - Theme-Classes: collapse multi-collapse block-mt block-mb bg-navy-deep text-snow
    ...
    Description:
      - H4-Heading: "Simple and easy to use"
  ...
  - Theme-Classes: collapse multi-collapse block-mt bg-navy text-snow
    ...
    Description:
      ...
      - H4-Heading: Category, Image & Headline
  ...
  - Theme-Classes: collapse multi-collapse block-mt bg-navy-deep text-snow
    ...
    Description:
      - H4-Heading: "Timestamps & Topic headings"
  ...
  - Theme-Classes: collapse multi-collapse block-mt bg-navy text-snow
    ...
    Subheading: ARTICLES
    Description:
      - H4-Heading: High engagement in headline, image & summary text
  ...
  - Theme-Classes: collapse multi-collapse block-mt bg-navy text-snow
    ...
    Subheading: ARTICLES
    Description:
        - H4-Heading: Images, quotes & subheadings helped to ease skim reading
  ...
  - Theme-Classes: collapse multi-collapse block-mt block-mb bg-navy-deep text-snow
    ...
    Description:
      ...
      - H4-Heading: "What people thought of the website in Mexico City"
  ...
  - Theme-Classes: collapse multi-collapse block-mt block-mb bg-navy text-snow
    id: multiCollapse_25
    Description:
      - H4-Heading: "What people thought of the website in Delhi"
    Media:
      - Layout-Classes: align-content-center col-sm-12
