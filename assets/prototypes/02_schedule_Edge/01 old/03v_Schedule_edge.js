   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid4786", tween: [ "style", "${_symDoubleHeight}", "display", 'block', { fromValue: 'none'}], position: 3990, duration: 0 },
            ...
            { id: "eid4669", tween: [ "style", "${_RoundRect}", "top", '621px', { fromValue: '621px'}], position: 2250, duration: 0 },
